...
function openPopup(rowData) {
    ...
    const barangays = [
        "Anonas", "Bayaoas", "Bactad East", "Bolaoen", "Cabaruan", 
        "Camantiles", "Camanang", "Catablan", "Cayambanan", "Consolacion", 
        "Dilan Paurido", "Dr. Pedro T. Orata (Bactad Proper)", "Labit Proper", 
        "Macalong", "Mabanogbog", "Nancalobasaan", "Nancamaliran East", 
        "Nancamaliran West", "Nancayasan", "Palina East", "Palina West", 
        "Pinmaludpod", "Poblacion", "San Jose", "San Vicente", 
        "Santa Lucia", "Santo Domingo", "Tulong"
    ]; 
