...
const populateTable = (pageNumber) => {
...
generatePaginationLinks();
    ...
    // Create view icon
    const viewIcon = createIcon('/static/icon/crimeTable/view.png', 'View');
    viewIcon.onclick = () => openPopup(rowData, false); // Attach click event for view
    actionCell.appendChild(viewIcon);

    // Create edit icon
    const editIcon = createIcon('/static/icon/crimeTable/edit.png', 'Edit');
    editIcon.onclick = () => openPopup(rowData, true); // Attach click event for edit
    actionCell.appendChild(editIcon);

    // Create delete icon
    const deleteIcon = createIcon('/static/icon/crimeTable/delete.png', 'Delete');
